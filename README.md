...
This project is a Web Traffic Analytics Dashboard created using Power BI with data retrieved through SQL queries. The dashboard presents a comprehensive analysis of website traffic over time, including various metrics like session duration, page views, bounce rates, and traffic sources, segmented by devices, regions, and browsers.
